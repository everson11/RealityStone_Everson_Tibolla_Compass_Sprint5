...
module Pages
    class Home < SitePrism::Page
        ...
        element :input_message_contact_us, 'textarea[name="messageContactUs"]'
        element :btn_send_message_contact_us, '#send_btnundefined'
        element :success_message, 'successMessage'

                def search_for(products)
            #header.btn_open_search.click
            #header.input_search.set products
            header.click_and_input_text_for_search(products)
            wait_until_loader_visible
            wait_until_loader_invisible
            header.btn_open_search.click
            header.close_search.click
        end
        def btn_send_message_contact_us(message_data)
